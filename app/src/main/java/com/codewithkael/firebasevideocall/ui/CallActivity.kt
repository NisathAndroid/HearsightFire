...
class CallActivity : AppCompatActivity(), MainService.EndCallListener {
    ...
    private fun init() {
        ...
        views.apply {
            ...
            serviceRepository.setupViews(isVideoCall, isCaller, target!!,isUsingUSBCamera)
    ...
    fun onUVCCheckBoxClick(view: View) {
        isUsingUSBCamera = findViewById<CheckBox>(R.id.uvcCheckBox).isChecked
